...
namespace AuthorizationServer
{
    ...
    public partial class XtklAuthorizationServer : ServiceClient<XtklAuthorizationServer>, IXtklAuthorizationServer
    {
        ...
        {
            BaseUri = new System.Uri("https://api-testing.sherweb.com/auth");
        ...
        /// </return>
        public async Task<HttpOperationResponse<Token>> TokenMethodWithHttpMessagesAsync(string clientId, string clientSecret, string scope, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (clientId == null)
            {
