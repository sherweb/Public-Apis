...
namespace Sherweb.Apis.Authorization
{
    ...
    public partial class AuthorizationService : ServiceClient<AuthorizationService>, IAuthorizationService
    {
        ...
        {
            BaseUri = new System.Uri("https://api.sherweb.com/auth");
        ...
        /// </return>
        public async Task<HttpOperationResponse<Token>> TokenMethodWithHttpMessagesAsync(string clientId, string clientSecret, string scope, string grantType, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (clientId == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "oidc/connect/token").ToString();
