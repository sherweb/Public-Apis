...
namespace Sherweb.Apis.Distributor
{
    ...
    public partial interface IDistributorService : System.IDisposable
    {
        ...
        /// </summary>
        /// <remarks>
        /// Get your payable charges data for a specific billing period. There
        /// are three types of charges that are included in
        /// the data returned: recurring, usage, and setup.
        /// </remarks>
        /// <param name='date'>
        /// Specify a date within the desired billing period. Format:
        /// yyyy-MM-dd (UTC). Default: Today. For
        /// example, if the date is March 17th and your billing period is from
        /// the 1st to the 31st of the month, it will return
